...
if( empty( $_SESSION['id_user'] ) ){
	...
	if( isset( $_REQUEST['aksi'] )){
		...
		echo '
			...
			<div class="container">
			<div class="col-md-8">
				<h3 style="margin-bottom: -20px;">Data Master Pelanggan Baru</h3>
					<a href="./admin.php?hlm=pelanggan&aksi=baru" class="btn btn-success btn-s pull-right">Tambah Data</a>
				<br/><hr/>
			...
			//skrip untuk menampilkan data dari database
		 	...
		 	if(mysqli_num_rows($sql) > 0){
				 ...
				 echo '<td colspan="8"><center><p class="add">Tidak ada data untuk ditampilkan. <u><a href="?hlm=pelanggan&aksi=baru">Tambah data baru</a></u> </p></center></td></tr>';
			}
			echo '
			 	</tbody>
			</table>
