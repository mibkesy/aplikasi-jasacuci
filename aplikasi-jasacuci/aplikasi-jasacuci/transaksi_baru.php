...
if( empty( $_SESSION['id_user'] ) ){
	...
	if( isset( $_REQUEST['submit'] )){
		...
		$sql = mysqli_query($koneksi, "INSERT INTO transaksi(no_nota, jenis, nama, nopol,petugas, bayar, kembali, total, tanggal, id_user) VALUES('$no_nota', '$jenis', '$nama','$nopol', '$petugas','$bayar', '$kembali', '$total', NOW(), '$id_user')");
...
<form method="post" action="" class="form-horizontal" role="form">
	...
	<div class="form-group">
		...
		<div class="form-group">
		<label for="nama" class="col-sm-2 control-label">Nopol</label>
		<div class="col-sm-4">
			<input type="text" class="form-control" id="nopol" name="nopol" placeholder="Nomor Polisi" required>
		</div>
	</div>
		<div class="form-group">
		<label for="nama" class="col-sm-2 control-label">Petugas</label>
		<div class="col-sm-4">
			<input type="text" class="form-control" id="petugas" name="petugas" placeholder="Petugas Cuci" required>
		</div>
	</div>
	<div class="form-group">
