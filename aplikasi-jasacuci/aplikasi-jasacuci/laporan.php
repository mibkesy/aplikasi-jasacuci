...
if( empty( $_SESSION['id_user'] ) ){
	...
	die();
      ...
      if(isset($_REQUEST['submit'])){
		 ...
		 echo '<h2>Rekap Laporan Penghasilan Bengkel Josh &nbsp;<small>'.$tgl1.' sampai '.$tgl2.'</small></h2><hr>
	 ...
	 echo '
		...
		echo '<h2>Laporan Penghasilan Jasa Cuci Mobil/Motor Bengkel Josh &nbsp; (<small>'.date('d-m-Y').'</small>)</h2><hr>';
